...
def get_ffprobe_info(filename, ffprobe):
...
def handle_video(filename, output, rotate_left, dry_run, ffmpeg, ffprobe):
    print("=========================================")
    print(f"= Input:  {filename}")
    print(f"= Output: {output}")
    print("=========================================")
    info = get_ffprobe_info(filename, ffprobe)
    ...
    # use UTC (Etc/UTC) timezone
    #   https://stackoverflow.com/a/35031412/11938767
    formatted_time = correct_time.astimezone(ZoneInfo('Etc/UTC')) \
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ffprobe', default='ffprobe', metavar='PATH',
